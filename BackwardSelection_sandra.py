...
Clean_df=pd.read_csv("datos_sandra.csv")
#Clean_df = Clean_df.drop(Clean_df.columns[0], axis=1)

#convertimos la columna de clase a 0 y 1


#class df será la columna 0 
class_df=Clean_df.iloc[:,0]
#class_df=Clean_df.loc[:, "categoria"]
#borramos la columna de clase
df_without_class = Clean_df.drop(Clean_df.columns[0], axis=1)
...
def main(X_class_1=X_class_1,X_class_2=X_class_2, desire_features=3):
    ...
    training_data_backwards_selection.to_csv("training_data_backwards_selection_sandra.csv")
